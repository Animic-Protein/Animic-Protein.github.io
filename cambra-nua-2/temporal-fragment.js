...
export function relateTemporalFragment(record,destinationKey){
 ...
 const next=evolveRecord(record,'relation',{kind:dest.kind,target:dest.target,label:dest.label,href:dest.href,traceRef:record.provenance?.originId||record.source?.id,suggested:false,humanDecision:true,decisionRequired:false,canonical:false,reversible:true});
