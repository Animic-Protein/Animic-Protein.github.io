...
assert.equal(local.laboratories.kreator_rpg_0_4.status, "experimental_no_canonical");
assert.equal(local.laboratories.kreator_rpg_0_4.default_dice, "d7xd9");
assert.equal(local.laboratories.kreator_rpg_0_4.effect_requires_prior_human_decision, true);
...
assert.equal(local.governance.current_construction, "kreator1_sessio01_ordre_causal_1_1");
assert.equal(local.governance.reentry_contract.impuls, "1.2");
assert.equal(local.governance.reentry_contract.mutatio_receptor, "0.2");
assert.equal(local.governance.reentry_contract.subject_required_before_destination, true);
assert.equal(local.governance.reentry_contract.kreator_session, "1.1-causal");
assert.equal(local.governance.reentry_contract.master_optional_before_human_decision, true);
